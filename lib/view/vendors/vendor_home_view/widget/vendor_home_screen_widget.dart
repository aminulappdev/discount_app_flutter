...
class VendorHomeScreenWidget extends GetxController {
  ...
  Rx<SingleStoreResponseModel> singleStoreResponseModel =
      SingleStoreResponseModel().obs;
  Rx<VendorProfileResponseModel> vendorProfileResponseModel =
      VendorProfileResponseModel().obs;
    ...
    Future.delayed(const Duration(milliseconds: 500), () async {
      ...
      if (permission == LocationPermission.denied) {
        ...
        CustomSnackBar().errorCustomSnackBar(
          context: context,
          message:
              "Location Permission need.Please go to app setting or unInstall the app",
        );
      } else {
  ...
  void onInit() {
    ...
    Future.delayed(Duration(seconds: 1), () async {
      await VendorProfileDetailsController.getVendorProfileApiService(
        onSuccess: (e) async {
          vendorProfileResponseModel.value =
              VendorProfileResponseModel.fromJson(e);
          await SingleStoreViewController.getSingleStoreViewApiService(
            storeId: vendorProfileResponseModel.value.data?.store?.sId ?? "",
            onSuccess: (e) async {
              isLoading.value = false;
              singleStoreResponseModel.value =
                  SingleStoreResponseModel.fromJson(e);
              await checkLocationPermission();
                            ...
                            Expanded(
                              child: Row(
                                ...
                                children: [
                                  ...
                                  // ),
                                  CustomSpaceWidget.spacerWidget(
                                    spaceWidth: 20.w(context),
                                  ),

                                  Icon(Icons.location_on, size: 32.r(context)),

                                  CustomSpaceWidget.spacerWidget(
                                    spaceWidth: 5.w(context),
                                  ),
                                    ...
                                    Expanded(
                                      child: ClipRRect(
                                        ...
                                        child: PageView.builder(
                                          ...
                                          itemCount: singleStoreResponseModel
                                              .value
                                              .data!
                                              .coverImages!
                                              .length,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                singleStoreResponseModel.value.data?.ratings !=
                                        null
                                    ? Row(
                                        children: [
                                          Row(
                                ...
                                SizedBox(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () async {
                                      Get.to(
                                        () => StorePositionScreenPage(
                                          long: singleStoreResponseModel
                                              .value
                                              .data!
                                              .location!
                                              .coordinates!
                                              .first,
                                          lat: singleStoreResponseModel
                                              .value
                                              .data!
                                              .location!
                                              .coordinates!
...
Widget _itemWidget({
  ...
  return Container(
    ...
    child: Column(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        ClipRRect(child: Image.asset(img, fit: BoxFit.cover)),
        Roundbutton(
          title: title,
